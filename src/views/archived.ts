...
export function openArchived(): void {
  ...
  function render(): void {
    ...
    container.querySelectorAll<HTMLButtonElement>("[data-restore-habit]").forEach((btn) => {
    ...
    container.querySelectorAll<HTMLButtonElement>("[data-restore-identity]").forEach((btn) => {
      btn.addEventListener("click", async () => {
