...
export function AddSavingsGoalSheet({ visible, onClose }: { visible: boolean; onClose: () => void }) {
  ...
  return (
    <Sheet visible={visible} onClose={onClose}>
      <ScrollView contentContainerStyle={{ paddingHorizontal: spacing.lg }} keyboardShouldPersistTaps="handled">
        ...
        <Button title="Create goal" onPress={handleSave} disabled={!canSave} loading={saving} />
      </ScrollView>
    </Sheet>
  );
}
