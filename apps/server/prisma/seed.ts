...
const recipes: RecipeSeed[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { instruction: "Lay a nori sheet on a bamboo mat, spread rice evenly over it, then flip rice-side down." },
      { instruction: "Arrange crab stick, avocado and cucumber in a line across the nori." },
      { instruction: "Roll tightly using the mat, sealing the edge with a little water." },
      { instruction: "Slice each roll into 6-8 pieces with a sharp, wet knife." },
    ],
  },
  {
