...
import { findCheckIn, isVote, isSkipped, isNeutralized, computeCurrentStreak, computeLongestStreak, completionRate, } from "../domain/analytics.js";
 ...
 */
function pickFocusHabit(due, checkins, today) {
      ...
      ${focus
        ? `<div class="focus-card" data-open-detail="${focus.habit.id}">
              ...
              <div class="focus-copy">
                ...
                <div class="focus-sub muted">Only ${Math.round(focus.rate * 100)}% completion this month — small steps count.${focus.habit.twoMinuteVersion ? ` Try: ${escapeHtml(focus.habit.twoMinuteVersion)}` : ""}</div>
              </div>
            </div>`
        : ""}
